    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publication_type', models.CharField(choices=[(1, 'Article'), (2, 'Blog Post')], max_length=20)),
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='edu.author')),
            ],
        ),
    ]
